    ...
    pub fn as_capability(&self) -> Capability {
        ...
        match event_type {
            ...
            EventType::KEY => match KeyCode::new(code) {
                ...
                KeyCode::BTN_TRIGGER_HAPPY9 => Capability::Gamepad(Gamepad::Button(GamepadButton::LeftPaddle1)),
                KeyCode::BTN_TRIGGER_HAPPY10 => Capability::Gamepad(Gamepad::Button(GamepadButton::LeftPaddle2)),
                KeyCode::BTN_TRIGGER_HAPPY11 => Capability::Gamepad(Gamepad::Button(GamepadButton::RightPaddle2)),
                KeyCode::BTN_TRIGGER_HAPPY12 => Capability::Gamepad(Gamepad::Button(GamepadButton::RightPaddle1)),
                KeyCode::BTN_TRIGGER_HAPPY7 => Capability::Gamepad(Gamepad::Button(GamepadButton::LeftPaddle3)),
                KeyCode::BTN_TRIGGER_HAPPY8 => Capability::Gamepad(Gamepad::Button(GamepadButton::RightPaddle3)),
                KeyCode::BTN_TRIGGER_HAPPY13 => Capability::Gamepad(Gamepad::Button(GamepadButton::Mute)),
                KeyCode::BTN_THUMBL => {
    ...
    match capability {
        ...
        Capability::Gamepad(gamepad) => match gamepad {
            Gamepad::Button(btn) => match btn {
                ...
                GamepadButton::LeftPaddle1 => vec![KeyCode::BTN_TRIGGER_HAPPY9.0],
                GamepadButton::LeftPaddle2 => vec![KeyCode::BTN_TRIGGER_HAPPY10.0],
                GamepadButton::LeftPaddle3 => vec![KeyCode::BTN_TRIGGER_HAPPY7.0],
                ...
                GamepadButton::RightPaddle1 => vec![KeyCode::BTN_TRIGGER_HAPPY12.0],
                GamepadButton::RightPaddle2 => vec![KeyCode::BTN_TRIGGER_HAPPY11.0],
                GamepadButton::RightPaddle3 => vec![KeyCode::BTN_TRIGGER_HAPPY8.0],
                ...
                GamepadButton::Mute => vec![KeyCode::BTN_TRIGGER_HAPPY13.0],
